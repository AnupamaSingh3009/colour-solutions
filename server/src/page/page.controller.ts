...
export class PageController {
  ...
  public async updatePage(
    @Param('id') id: string,
    @Body() updatePagePayload: UpdatePagePayload,
    @Req() req: any,
  ) {
    const user = req.user as unknown as ToUserDto;
  ...
  @Get('link/:link')
  public async getPageByName(@Param('link') link: string): Promise<PageDto> {
    return this.pageService.findByLink(link);
  }

  @Delete(':id')
  @UseGuards(AuthGuard())
  public async deletePage(@Param('id') id: string): Promise<boolean> {
